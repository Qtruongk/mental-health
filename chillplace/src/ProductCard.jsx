      ...
      <div className="container-pc">
        ...
        <div className="products">
          <div className="product">
            ...
            <div className="bay">
              <button onClick={() => openLink(0)}></button>
            </div>
          </div>
          ...
          <div className="product">
            ...
            <div className="gap"></div>
            <div className="bay">
              <button onClick={() => openLink(1)}></button>
            </div>
          </div>
          ...
          <div className="product">
            ...
            <div className="gap"></div>
            <div className="bay">
              <button onClick={() => openLink(2)}></button>
            </div>
          </div>
          ...
          <div className="product">
            ...
            <div className="gap"></div>
            <div className="bay">
              <button onClick={() => openLink(3)}></button>
            </div>
          </div>
          ...
          <div className="product">
            ...
            <div className="gap"></div>
            <div className="bay">
              <button onClick={() => openLink(4)}></button>
            </div>
          </div>
          <div className="product">
            <div className="image-pc">
            ...
            <div className="gap"></div>
            <div className="bay">
              <button onClick={() => openLink(5)}></button>
            </div>
          </div>
          <div className="product">
            <div className="image-pc">
            ...
            <div className="gap"></div>
            <div className="bay">
              <button onClick={() => openLink(6)}></button>
            </div>
          </div>
          <div className="product">
            <div className="image-pc">
            ...
            <div className="gap"></div>
            <div className="bay">
              <button onClick={() => openLink(7)}></button>
            </div>
          </div>
        </div>
      </div>
